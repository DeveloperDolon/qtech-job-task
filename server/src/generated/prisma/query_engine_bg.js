...
var L = (e, t) => {
  ...
  N = (e, t, n, r) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let o of B(t)) !U.call(e, o) && o !== n && F(e, o, { get: () => t[o], enumerable: !(r = j(t, o)) || r.enumerable });
    return e;
  };
...
let I = 0;
function W(e, t) {
  return ((I += t), I >= V && ((S = new TextDecoder("utf-8", { ignoreBOM: !0, fatal: !0 })), S.decode(), (I = t)), S.decode(y().subarray(e, e + t)));
}
function w(e, t) {
  return ((e = e >>> 0), W(e, t));
}
...
function l() {
  return (
    (p === null || p.buffer.detached === !0 || (p.buffer.detached === void 0 && p.buffer !== _.memory.buffer)) && (p = new DataView(_.memory.buffer)),
    p
  );
}
function a(e) {
