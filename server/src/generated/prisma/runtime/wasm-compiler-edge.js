...
var me = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  ...
  Vo = (e, t, r, n) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of au(t)) !cu.call(e, i) && i !== r && Kr(e, i, { get: () => t[i], enumerable: !(n = su(t, i)) || n.enumerable });
    return e;
  };
var $e = (e, t, r) => ((r = e != null ? ou(lu(e)) : {}), Vo(t || !e || !e.__esModule ? Kr(r, "default", { value: e, enumerable: !0 }) : r, e)),
...
var h,
  ...
  c = ye(() => {
    ...
    ((mu = {
      ...
      (du = new TextEncoder()),
      (fu = new TextDecoder()),
      (gu = ["utf8", "utf-8", "hex", "base64", "ascii", "binary", "base64url", "ucs2", "ucs-2", "utf16le", "utf-16le", "latin1", "latin-1"]),
      (yu = 4294967295));
    uu(h.prototype);
    ((y = new Proxy(hu, {
      construct(e, [t, r]) {
    ...
    (r !== void 0 &&
      ...
      (f =
        r < 4
          ? (a || f) && (r == 0 || r == (e.s < 0 ? 3 : 2))
          : a > 5 ||
            (a == 5 && (r == 4 || f || (r == 6 && ((n > 0 ? (i > 0 ? w / ze(10, s - i) : 0) : R[A - 1]) % 10) & 1) || r == (e.s < 0 ? 8 : 7))))),
    t < 1 || !R[0])
  )
    return (
      f
  ...
  Yo = ye(() => {
    ...
    I.toExponential = function (e, t) {
      ...
      return (
        e === void 0
          ? (r = Ze(n, !0))
          : (Re(e, 0, mt), t === void 0 ? (t = i.rounding) : Re(t, 0, 8), (n = q(new i(n), e + 1, t)), (r = Ze(n, !0, e + 1))),
        r
      );
    };
    ...
    I.toSignificantDigits = I.tosd = function (e, t) {
      var r = this,
        n = r.constructor;
      return (
        e === void 0 ? ((e = n.precision), (t = n.rounding)) : (Re(e, 1, mt), t === void 0 ? (t = n.rounding) : Re(t, 0, 8)),
        q(new n(r), e, t)
      );
    };
    I.toString =
    ...
    _e = (function () {
      ...
      return function (n, i, o, s) {
        ...
        if (((ue = (ue / H + 2) | 0), (w = 0), xe == 1))
          for (A = 0, z = z[0], ue++; (w < Ke || A) && ue--; w++) ((B = A * te + (ve[w] || 0)), (L[w] = (B / z) | 0), (A = (B % z) | 0));
        else {
          for (
            A = (te / (z[0] + 1)) | 0,
...
var Es,
  ...
  xs = ye(() => {
    ...
    ((Es = "/"), (Ku = ":"));
    ((Yu = { sep: Es }),
      (Zu = { basename: ws, delimiter: Ku, dirname: bs, join: Ju, normalize: zu, parse: Wu, posix: Yu, resolve: Gu, sep: Es }),
      (rn = Zu));
  });
var xi = {};
      ...
      for (var Ke = pe.length - 1; a < o - 3; )
        for (
          ...
          ((L = pe[f]),
            ...
            (w = L));
      for (; a < o; )
        for (M = r.charCodeAt(s + (w = a)), C = ++a, f = 0; f < Ke; f += 2) ((L = pe[f]), (pe[f] = C = e(L, w, C, M, pe[f + 1])), (w = L));
      return C;
    };
  })();
});
...
var Cl = me((_) => {
  ...
  var Fn = BigInt(2 ** 32 - 1),
    eo = BigInt(32);
  function to(e, t = !1) {
    return t ? { h: Number(e & Fn), l: Number((e >> eo) & Fn) } : { h: Number((e >> eo) & Fn) | 0, l: Number(e & Fn) | 0 };
  }
  function sl(e, t = !1) {
...
var Jl = me((RL, Je) => {
  ...
  var jl = (e = "") => Bl(ud(e)).toString(36).slice(1),
    ...
    Hl = (e) => () => e++,
    md = 476782367,
    Gl = ({ random: e = Math.random, counter: t = Hl(Math.floor(e() * md)), length: r = ql, fingerprint: n = Ql({ random: e }) } = {}) =>
      function () {
        let o = pd(e),
...
function Ys(e, t, r) {
  let n = Ie(r);
  return !t.result || !(t.result.$allModels || t.result[n]) ? e : $p({ ...e, ...zs(t.name, e, t.result.$allModels), ...zs(t.name, e, t.result[n]) });
}
function $p(e) {
  let t = new Ce(),
...
function zs(e, t, r) {
  return r ? pn(r, ({ needs: n, compute: i }, o) => ({ name: o, needs: n ? Object.keys(n).filter((s) => n[s]) : [], compute: Vp(t, o, i) })) : {};
}
function Vp(e, t, r) {
  let n = e?.[t]?.compute;
      ...
      let o = i,
        s = (a) => (f) => {
          ...
          return e._createPrismaPromise(
            (A) => {
              let R = { args: f, dataPath: [], action: o, model: t, clientMethod: `${r}.${i}`, jsModelName: r, transaction: A, callsite: w };
...
function Sa({ result: e, modelName: t, args: r, extensions: n, runtimeDataModel: i, globalOmit: o }) {
  return n.isEmpty() || e == null || typeof e != "object" || !i.models[t]
    ...
    : Nn({
        ...
        visitor: (a, f, w) => {
          let A = Ie(f);
          return Ra({ result: a, modelName: A, select: w.select, omit: w.select ? void 0 : { ...o?.[A], ...w.omit }, extensions: n });
        },
      });
}
c();
...
function br(e) {
  return JSON.stringify(e, (t, r) =>
    typeof r == "bigint" ? r.toString() : ArrayBuffer.isView(r) ? y.from(r.buffer, r.byteOffset, r.byteLength).toString("base64") : r,
  );
}
function xm(e) {
...
function Ji(e) {
  throw nn(e)
    ? new ce(`Raw query failed. Code: \`${e.cause.originalCode ?? "N/A"}\`. Message: \`${e.cause.originalMessage ?? Ya(e)}\``, "P2010", {
  ...
  return t.arguments.map((i) => {
    ...
    if (o === -1)
      return t.expectNonEmpty
        ? new ce("An operation failed because it depends on one or more records that were required but not found", "P2025")
        : null;
    {
...
async function Ln({ query: e, tracingHelper: t, provider: r, onQuery: n, execute: i }) {
  return await t.runInChildSpan({ name: "db_query", kind: Er.CLIENT, attributes: { "db.query.text": e.sql, "db.system.name": Sm(r) } }, async () => {
    let o = new Date(),
      s = b.now(),
      a = await i(),
      f = b.now();
...
var bd = 128,
  ...
  Lt;
function Ed(e) {
  (!nt || nt.length < e ? ((nt = y.allocUnsafe(e * bd)), Xt.getRandomValues(nt), (Lt = 0)) : Lt + e > nt.length && (Xt.getRandomValues(nt), (Lt = 0)),
    (Lt += e));
}
function so(e = 21) {
  Ed((e |= 0));
...
function sc(e) {
  return { columns: e.columnNames, types: e.columnTypes.map((t) => qd(t)), rows: e.rows.map((t) => t.map((r, n) => $t(r, e.columnTypes[n]))) };
}
function $t(e, t) {
  if (e === null) return null;
  switch (t) {
...
var Wd = 100,
  ...
  kr = class {
    ...
    async #r(t) {
      let r = { id: await uc(), status: "waiting", timer: void 0, timeout: t.timeout, startedAt: Date.now(), transaction: void 0 };
    ...
    #n(t, r) {
      ...
      if (["committed", "rolled_back", "timed_out"].includes(n.status)) throw new Vt("Closed transaction found in active transactions map.");
      return n;
    }
      ...
      let n = async () => {
        ...
        try {
          if (t.transaction && r === "committed")
            ...
            if (t.transaction.options.usePhantomQuery) await this.#o(Zd(), t.transaction, () => t.transaction.rollback());
            else {
              let i = zd();
...
function Ec(e) {
  ...
  return (
    i == 1
      ...
      : i == 2 &&
        ((A = (t[o] << 8) | t[o + 1]), (s = (A & 64512) >> 10), (a = (A & 1008) >> 4), (f = (A & 15) << 2), (r += Fe[s] + Fe[a] + Fe[f] + "=")),
    r
  );
}
c();
...
`);
  ...
  !A &&
    ...
    s(["recommend--no-engine", "In production, we recommend using `prisma generate --no-engine` (See: `prisma generate --help`)"]);
  let S = R || !r;
  A &&
    (S || n === "edge") &&
    (n === "edge"
...
function Cc({ copyEngine: e = !0 }, t) {
  ...
  let { ok: n, isUsing: i, diagnostics: o } = Rc({ url: r, adapter: t.adapter, copyEngine: e, targetBuildType: "wasm-compiler-edge" });
...
var Rf = K("prisma:client:request_handler"),
  li = class {
      ...
      ((this.logEmitter = r),
        ...
        (this.dataloader = new si({
          batchLoader: Ma(async ({ requests: n, customDataProxyFetch: i }) => {
            ...
            return (await this.client._engine.requestBatch(a, { traceparent: f, transaction: Cf(o), containsWrite: w, customDataProxyFetch: i })).map(
              (R, S) => {
    ...
    handleRequestError({ error: t, clientMethod: r, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
      ...
      let f = t.message;
      if (
        (n && (f = dn({ callsite: n, originalMethod: r, isPanic: t.isPanic, showColors: this.client._errorFormat === "pretty", message: f })),
      ...
      try {
        ...
        if (
          ...
          (this._engineConfig = {
            ...
            logQueries:
              f.log &&
              !!(typeof f.log == "string" ? f.log === "query" : f.log.find((C) => (typeof C == "string" ? C === "query" : C.level === "query"))),
            env: a?.parsed ?? {},
            flags: [],
    ...
    $executeRaw(n, ...i) {
      return this._createPrismaPromise((o) => {
        if (n.raw !== void 0 || n.sql !== void 0) {
          let [s, a] = Xc(n, i);
          return (
            Mo(this._activeProvider, s.text, s.values, Array.isArray(n) ? "prisma.$executeRaw`<SQL>`" : "prisma.$executeRaw(sql`<SQL>`)"),
